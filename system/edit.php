...
<div style="text-align: center">
    ...
    <?php
    if ($_GET['myid']=='root'){
        echo "<a href='index_sup.php?myid=$_GET[myid] ' >主页</a>";
    }else{
        echo "<a href='index.php?myid=$_GET[myid] ' >主页</a>";
    }
...
<div align="center">
    ...
    //不同身份修改信息的跳转
    if ($_GET['myid']=='root'){
        echo"     <form action=\"action.php?action=Edt&id=$id&myid=root\" method=\"post\"  enctype=\"multipart/form-data\"> ";
    }elseif ($arr['identity']=='teacher'){
        echo"     <form action=\"action.php?action=Tra&id=$id&myid=teacher\" method=\"post\"  enctype=\"multipart/form-data\"> ";
    }else{
        echo"     <form action=\"action.php?action=Tra&id=$id&myid=student\" method=\"post\"  enctype=\"multipart/form-data\"> ";
    }
    ?>
...
<!--    信息的录入-->
        <table  >
            ...
            <tr>
                ...
                <td>
                    <input name="idtype" type="radio" value="town"  <?php echo ($arr['idtype']=='town')?"checked":""  ?> >城镇
                    <input name="idtype" type="radio" value="vill" <?php echo ($arr['idtype']=='vill')?"checked":""  ?> >居民
                </td>
            </tr>
            <tr>
                <td>
